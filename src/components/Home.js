import smilePath from '../images/smile.png';
      ...
      <div className="width-container">
        <div className="home__content">
          <div className="home__info">
            <h1 data-aos="fade-right" className="home__title">
              Front-End React разработчик
              <img className="home__smile" src={smilePath} alt="картинка приветствия рука" />
            </h1>
            <p data-aos="fade-left" className='home__text'>
              Привет, я Данис - junior frontend-developer.
            </p>
            <div data-aos="fade-right" className='home__links'>
              <a rel='noreferrer' target='_blank' href='https://www.linkedin.com/in/danis-tazhitdinov' className='home__link'>
              ...
              <a rel='noreferrer' target='_blank' href='https://github.com/danchikSlaziet' className='home__link'>
            ...
            <div data-aos="fade-up" className='home__skills'>
              <p className='home__skill-text'>Cтек</p>
              <div className='logos'>
                <ul>
                  <li>
          ...
          <div data-aos="fade-up" className='home__avatar'>
